...
char GATLINGdescription[200] = "[消耗牌]對所有其他玩家進行射擊\n";
char INDIANSdescription[200] = "[消耗牌]所有玩家棄掉一張BANG\n";
char PANICdescription[200] = "[消耗牌]從距離為1的玩家拿取一張牌\n";
char CAT_BALOUdescription[200] = "[消耗牌]指定一名玩家棄掉一張牌\n";
char STAGECOACHdescription[200] = "[消耗牌]從牌庫頂抽2張牌\n";
char WELLS_FARGOdescription[200] = "[消耗牌]從牌庫頂抽3張牌\n";
char GENERAL_STOREdescription[200] = "[消耗牌]從牌庫頂抽出與當前存活玩家數相同的牌，依序挑選一張\n";
char BEERdescription[200] = "[消耗牌]恢復一點血量(子彈)\n";
char SALOOWdescription[200] = "[消耗牌]所有玩家恢復一點血量(子彈)\n";
char DUELdescription[200] = "[消耗牌]目標玩家與當前玩家輪流出「BANG」，由目標玩家開始，無法繼續者扣一點血量\n";
char BARRELdescription[200] = "[裝備牌]抽牌判定，若是愛心等同使用MISSED\n";
char SCOPEdescription[200] = "[裝備牌]你看所有玩家距離減1\n";
char MUSTANGdescription[200] = "[裝備牌：馬]所有其他玩家看你的距離加1\n";
char APPALOOSAdescription[200] = "[裝備牌：馬]你看所有玩家距離減1\n";
char JAILdescription[200] = "[裝備牌]監禁除了警長的任何一人，抽牌判定，愛心繼續回合，其他跳過回合，判定後棄掉JAIL\n";
char DYNAMITEdescription[200] = "[裝備牌]放在自己面前，從下輪自己開始抽牌判定往左邊玩家傳，黑桃2~9會損3點血\n";
char VOLCANICdescription[200] = "[裝備牌：槍]可以使用任意張數「BANG」\n";
char SCHOFIELDdescription[200] = "[裝備牌：槍]射擊距離變成2\n";
char REMINGTONdescription[200] = "[裝備牌：槍]射擊距離變成3\n";
char REV_CARABINEdescription[200] = "[裝備牌：槍]射擊距離變成4\n";
...
char Jourdonnaisdescription[200] = "當被Bang時，可以從遊戲牌堆抽一張牌，若是紅心則可以當作MISSED，可再裝備BARREL\n";
char Kit_Carlsondescription[200] = "抽牌階段時，可以從遊戲牌堆上方拿三張起來看，選擇兩張，放回一張到遊戲牌堆頂端\n";
char Lucky_Dukedescription[200] = "當發生判定需要抽牌時，他可以抽兩張，並選擇一張當要判定的牌，判定結束後抽起來的兩張都 要丟棄\n";
char Paul_Regretdescription[200] = "其他玩家看他的距離+1\n";
char Pedro_Ramirezdescription[200] = "在抽牌階段時，第一張牌可以選擇從棄牌堆或遊戲牌堆中抽牌，第二張牌只能從遊戲牌中抽牌\n";
char Rose_Doolandescription[200] = "看別的玩家的距離-1\n";
char Sid_Ketchumdescription[200] = "任何時刻都可以丟棄兩張卡牌，替自己補一滴血，且次數不限\n";
char Slab_the_Killerdescription[200] = "其他玩家要躲過他出的BANG必須出兩張MISSED。如果其他人的BARREL成功觸發躲過時，只算一次MISSED，還需要再出一張MISSED才能真正躲過他的BANG\n";
